...
const $$Contacto = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Contacto" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="py-6 bg-gray-200 max-w-[40%] mx-auto my-12 rounded-md"> <div class="container mx-auto px-8"> <h2 class="text-3xl font-bold text-center text-green-600 mb-6">
Contacto
